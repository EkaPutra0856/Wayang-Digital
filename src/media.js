export class MediaController {
  constructor(video,audio,assets,onChange,onError) {
    Object.assign(this,{video,audio,assets,onChange,onError});
  ...
  async playVideo(scene,onStarted) {
  ...
  finish() {this.active=false;this.loading=false;this.buffering=false;this.scene=null;this.onChange();}
